...
$ruleName = $policyName + "UseNewRecovery"
(ni prm::rules\$ruleName -rt "UseNewRecovery" -policies $policyName)

$ruleName = $policyName + "AllowChangeLayout"
(ni prm::rules\$ruleName -rt "AllowChangeLayout" -policies $policyName)

$ruleName = $policyName + "ProportionalResizeProhibited"
(ni prm::rules\$ruleName -rt "ProportionalResizeProhibited" -policies $policyName)
